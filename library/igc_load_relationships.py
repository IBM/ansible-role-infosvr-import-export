...
description:
  - "Loads metadata relationships into an IBM Information Governance Catalog environment, based on the criteria provided"
...
options:
  ...
  asset_type:
    description:
      - The IGC REST asset type (eg. C(term)) for which to load relationships. (See "GET /ibm/iis/igc-rest/v1/types" in your environment for choices.)
    required: true
    type: str
  relationship:
    description:
      - The IGC REST asset's property (eg. C(assigned_assets)) to use to load relationships. (See "GET /ibm/iis/igc-rest/v1/types/<asset_type>?showEditProperties=true&showViewProperties=true&showCreateProperties=true" in your environment for choices.)
    required: true
    type: str
  src:
    description:
  ...
  mappings:
    description:
      - A list of mappings defining any translation of metadata to be applied to any of the assets that compose the relationships (eg. host names, database names, etc)
    required: false
    type: list
    default: []
    suboptions:
      type:
        description:
          - The type of asset for which to define a mapping. (See "GET /ibm/iis/igc-rest/v1/types" in your environment for choices.)
        required: true
        type: str
      property:
        description:
  ...
  conditions:
    ...
    suboptions:
      property:
        description:
          - The property of the I(replace_type) to set the condition against. (See "GET /ibm/iis/igc-rest/v1/types/<asset_type>?showEditProperties=true&showViewProperties=true&showCreateProperties=true" in your environment for choices.)
        required: true
        type: str
      operator:
        description:
